...
select 
nv.ho_ten, td.ten_trinh_do, bp.ten_bo_phan, nv.so_dien_thoai, nv.dia_chi, count(nv.ma_nhan_vien)  as 'a'
from nhan_vien nv 
left join hop_dong hd 
...
where lk.ten_loai_khach_hang like '%Platinium';
